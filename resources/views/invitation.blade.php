    ...
    {{-- <div class=" fixed top-0 right-0 sm:block w-full">
            ...
            <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
                ...
                <div class="flex md:order-2">
                    ...
                    @auth
                    <a href="{{ route('admin.scraper') }}" class="mx-3 text-white bg-emerald-500 hover:bg-emerald-600 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-emerald-600 dark:hover:bg-emerald-500 dark:focus:ring-emerald-800">{{__('Dashboard')}}</a>
