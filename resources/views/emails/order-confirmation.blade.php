                                          ...
                                          <tr>
                                            <td style='width:110px;'>
                                              <a href='#' target='_blank'>
                                                <img alt='item1' height='auto' src="{{ $message->embed(public_path('images/' . $article->image))}}" style='border: 1px solid #e6e6e6;border-radius:4px;display:block;font-size:13px;height:auto;outline:none;text-decoration:none;width:100%;' width='110' />
                                              </a>
                                            </td>
                                          </tr>
                                        </tbody>
