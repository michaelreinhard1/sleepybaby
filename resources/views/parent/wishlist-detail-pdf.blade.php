                                      ...
                                      <tr>
                                        <td align='left' style='font-size:0px;padding:0px;word-break:break-word;'>
                                          <table border='0' cellpadding='0' cellspacing='0' style='cellpadding:0;cellspacing:0;color:#000000;font-family:Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;' width='100%'>
                                            <tr>
                                              <td align='center'>
                                                <a href='https://sleepybaby.michaelreinhard.be'style="direction: ltr;
                  ...
                  <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='vertical-align:top;' width='100%'>
                    <tr>
                      <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                        ...
                        <p style="color:#4d4d4d;font-family:Oxygen, Helvetica neue, sans-serif;font-size:14px;font-weight:700;line-height:37px;text-align:center;">
                          {{$share_url}}
                        </p>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td align='left' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                        ...
                        @foreach($articles as $article)
                          <tr style="font-size:14px; line-height:19px; font-family: 'Oxygen', 'Helvetica Neue', helvetica, sans-serif; color:#777777 margin-top:15px">
                            <td width='50%'>
                ...
                <table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='width:100%;'>
                  <tbody>
                    <tr>
                        ...
                        <p style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';line-height:1.5em;margin-top:0;color:#b0adc5;font-size:12px;text-align:center">© 2022 {{env('APP_NAME')}}. {{__('All rights reserved')}}.</p>
                        </td>
                        </tr>
                    </tbody>
                </table>
